...
一般来说论文应该包括的章节有 Introduction，Objective, Method, Result, Discussion, Conclusion. 也就是引言，研究问题、方法，结果，讨论和结论。有学者按照各部分的主要逻辑，将这几部分又分成了 3 部分：引言段，中间段，和结论段。其中引言段和结论段是观点论证型，中间段是清晰准确地说明研究过程，而非论证型。很多人觉得引言段和结论段难写，因为是观点论证型，要有充足的论据和合理的论证逻辑。

引言段的作用是论文你的研究在你所研究的领域，处于什么位置，主要论证选题的学术合理性，它要得出的结论应该是这篇论文的研究目标是合理的，它的论据就是从文献中搜集而来的相关资料。引言段的论述一般是从普遍到特定，聚焦到明确的小切口的一个研究问题。引言段可以在研究正式开始前就动手写，引言段的写作并不需要研究数据。并且引言段的写作，也为更好地进行研究打下基础。

结论段要得出的结论应该是这篇论文是有价值的，它的论据是我们的研究结果和从文献中搜集而来的相关资料。而结论段的论述一般是从特定到普遍，是从更宏观一些的视角在研究结论的基础上展开更高层面的理论想象和分析。

中间段使用术语，将我们的研究方法和研究过程清晰准确地说出来即可。

论文各部分的功能，也告诉我们，看论文时先看引言和结论，如果有必要深入了解研究过程，再看中间段即可。

## 题目

论文题应简短、明确、有概括性，字数要适当，不宜超过 25 个字，如果有些细节必须放进标题，可以分成主标题和副标题，主标题写得简明，将细节放在副标题里。

## 摘要、关键词

摘要是论文内容不加注释和评论的简短陈述，它具有独立性和自含性，它应以浓缩的形式概括研究课题的内容、方法和观点，以及取得的成果和结论，应能反映整个内容的精华。撰写摘要时，应注意突出学位论文中的创造性成果和创新见解。中文摘要以 300—400 字为宜，外文摘要以 250-300 个左右实词为宜。
...
引言（绪论）非常重要，应该是一篇完整的议论文。它的主要目标是论述研究问题的合理性。
...
引言部分从逻辑上至少可以分为两部分：第一部分，确立研究机会（前面的 1、2）。在第二部分，提出解决方案，占领这个研究机会（3,4,5）。

确立研究机会，从一个较为普遍的大问题（problem）开始，到确立一个研究空白（gap）或者提出具体的问题（question）结束。为了一个普遍的大问题，我们需要回答一些更具体的问题。在这一部分，作者最好提出一些读者关切的问题，从读者已经接受的、已经认同的观念入手，逐渐加入读者可能未知的文献资料，并且以这些文献资料作为理由，说服读者有一个具体的研究问题值得研究。

该部分的论述模式可以如下：

```
问题X的重要性已经被学术界广泛认可，研究者A发现了a，研究者B发现了b，……，基于以上研究基础，我们认为，回答问题Q对于解决X至关重要。
```

在第二部分，要清晰地描述我们的研究目标，去填补在第一部分确立的研究空白，从而占领这个研究机会。完整的研究目标，不但包含本篇论文的研究目标（objective），还包括作者在这一领域的长期目标（goal）。为了实现长期目标，需要首先实现本篇论文的研究目标。
...
1. 如何写论文 5 分钟系列讲座 01 论文的三段式结构. 见于 2020 年 11 月 1 日. <https://www.youtube.com/watch?v=d6Za4VRiDIc&t=70s&ab_channel=Dr.LiuResearchTIPS>.
